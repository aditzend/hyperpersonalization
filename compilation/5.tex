...
Los experimentos efectuados en la sección de desarrollo demuestran que el mecanismo diseñado cumple la premisa dotando de capacidades de hiperpersonalización a un asistente virtual. La combinación de modelos de lenguaje preentrenados y \textit{embeddings} es suficiente para procesar la información necesaria siempre que la cantidad de información almacenada pueda ser procesada efectivamente por el motor de búsqueda de la base vectorial.
...
Por último, la validación realizada en este trabajo es de carácter cualitativo: se apoya en la inspección de las respuestas del sistema sobre casos de uso concretos, lo que resulta adecuado para una prueba de concepto. Una evaluación cuantitativa —con métricas de precisión y exhaustividad en la recuperación, exactitud sobre un conjunto fijo de preguntas y una comparación sistemática entre modelos— excede el alcance de este trabajo y queda planteada como línea de trabajo futuro.

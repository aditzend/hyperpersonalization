...
\subsection{Anclas empíricas de mercado para estimaciones Delphi}
...
\subsubsection{Adopción real en empresas}
...
\subsubsection{Conversión comercial, precios y contratos, CAC, churn, e implementación}
...
\begin{itemize}
  ...
  \item \textbf{CAC y eficiencia comercial (CAC/ACV; payback; prima por operar fuera de mercados principales).} \textbf{No cuantificado en fuentes provistas.}
...
\subsubsection{Distribución geográfica del gasto en IA}
...
\subsubsection{Implicancias operativas para el Delphi}

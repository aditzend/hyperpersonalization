...
La transcripción íntegra de este listado figura en el \textit{Anexo técnico} (véase el Apéndice~\ref{anexo:code-4-4-2-1}).
...
La transcripción íntegra de este listado figura en el \textit{Anexo técnico} (véase el Apéndice~\ref{anexo:code-4-4-2-2}).

\paragraph{Clase cliente para Atlas}

La transcripción íntegra de este listado figura en el \textit{Anexo técnico} (véase el Apéndice~\ref{anexo:code-4-4-2-3}).

\paragraph{Procesamiento y carga de registros médicos}

La transcripción íntegra de este listado figura en el \textit{Anexo técnico} (véase el Apéndice~\ref{anexo:code-4-4-2-4}).

\paragraph{Inserción en la colección Records}

La transcripción íntegra de este listado figura en el \textit{Anexo técnico} (véase el Apéndice~\ref{anexo:code-4-4-2-5}).

\paragraph{Amplificación de consultas y búsqueda vectorial}

La transcripción íntegra de este listado figura en el \textit{Anexo técnico} (véase el Apéndice~\ref{anexo:code-4-4-2-6}).

\paragraph{Generación de respuesta final}

La transcripción íntegra de este listado figura en el \textit{Anexo técnico} (véase el Apéndice~\ref{anexo:code-4-4-2-7}).

...
El listado completo figura en el Anexo técnico (p.~\pageref{anexo:code-4-4-2-1}).
...
La base de conocimientos sobre Norman alcanzó los 187 documentos sobre personas en su vida, registros médicos y gastos.\footnote{La cifra corresponde a los documentos efectivamente insertados en la colección \texttt{Records}. El procedimiento de ingestión incorpora únicamente los registros que cuentan con un campo de fecha (\texttt{datetime}) válido, por lo que algunos registros médicos sin fecha asociada quedaron fuera de la colección. El conteo se reparte entre los tres tipos: registros de personas, médicos y de gastos.}

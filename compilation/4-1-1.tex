...
El código implementado puede consultarse en detalle en el repositorio\footnote{\url{https://github.com/aditzend/hyperpersonalization/blob/main/app/notebooks/1.ipynb}}. La transcripción íntegra del listado se presenta en el \textit{Anexo técnico} (véase el Apéndice~\ref{anexo:tecnico}).

...
Se instala localmente o en el entorno del cliente, actuando como un \textit{middleware} entre las fuentes de datos y el motor del bot.

\textbf{Características principales:}
\begin{itemize}
    \item Observa el flujo de las conversaciones.
    \item Proporciona contexto adecuado basado en los datos disponibles.
    \item Procura la hiperpersonalización resguardando la seguridad y la privacidad de los datos, mediante el despliegue en el perímetro del cliente y controles de prevención de fuga de datos sobre la información que se envía a servicios externos de inferencia.
\end{itemize}

...
Las empresas de transporte podrían reducir entre un 30\% y un 50\% las consultas manejadas por humanos. Según Botpress, los chatbots pueden responder hasta el 79\% de las consultas rutinarias en atención al cliente \parencite{Botpress2024}. Pero se toma un valor más conservador dado que cada implementación tiene fuerte dependencia del contexto.

No solo se verificaría un ahorro de costos sino un incremento sustancial en ventas adicionales (asientos, equipaje, upgrades) con un engagement superior en tiempo real. McKinsey \& Company estima que la personalización puede aumentar los ingresos en torno al 15\%, con picos mayores según el sector y la capacidad de ejecución, y que cerca del 72\% de los consumidores espera que las empresas los reconozcan como individuos \parencite{McKinsey2021}.

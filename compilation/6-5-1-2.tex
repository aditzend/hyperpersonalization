...
\begin{center}
\captionof{table}{Matriz de riesgos, mitigaciones y KPIs operativos}
\label{tab:matriz-riesgos}
\footnotesize
\begin{adjustbox}{width=\textwidth,center}
\begin{tabular}{p{2.8cm}ccp{4.2cm}crp{2.8cm}}
\hline
...
\begin{itemize}
    ...
    \item \textbf{Límites de responsabilidad}: Se establecen topes de responsabilidad y exclusiones estándar para un servicio de \textit{middleware}, distinguiendo entre incidentes atribuibles a la plataforma y aquellos originados en la configuración o datos del cliente.
\end{itemize}
...
\begin{center}
\captionof{table}{Costos mensuales de cumplimiento y seguridad}

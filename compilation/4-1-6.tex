...
El listado completo figura en el Anexo técnico (p.~\pageref{anexo:code-4-1-6-1}).

La función para interactuar con GPT-3.5 se define como:

El listado completo figura en el Anexo técnico (p.~\pageref{anexo:code-4-1-6-2}).
...
El listado completo figura en el Anexo técnico (p.~\pageref{anexo:code-4-1-6-3}).
...
El listado completo figura en el Anexo técnico (p.~\pageref{anexo:code-4-1-6-4}).
...
El listado completo figura en el Anexo técnico (p.~\pageref{anexo:code-4-1-6-5}).
...
El listado completo figura en el Anexo técnico (p.~\pageref{anexo:code-4-1-6-6}).
